...
<?php
        ...
        if(isset($_POST)){
            ...
            $db = $GLOBALS['db'];
            $statement = $db->prepare('INSERT INTO `submitted_process`(`process_form_id`, `submitted_process_response`, `submitted_process_creator`, `process_status`) VALUES (1,:jsonresponse,:userid, 1);');
